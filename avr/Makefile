...
elf: $(TARGET).u.elf $(TARGET).elf
hex: $(TARGET).u.hex $(TARGET).hex
eep: $(TARGET).u.eep $(TARGET).eep
lss: $(TARGET).u.elf.lss $(TARGET).elf.lss
sym: $(TARGET).u.sym $(TARGET).sym
